...
// 取得所有學生文章
$sql = "SELECT p.*, u.username as student_name, 
...
<head>
    ...
    <style>
        body { margin:0; font-family: 'Noto Sans TC', Arial, sans-serif; background:#f7f8fa; }
        .notion-layout { 
            display:flex; 
            height:100vh; 
            min-height:600px; 
    ...
    <div class="notion-layout">
        <div class="notion-sidebar">
            ...
            <ul class="notion-category-list">
                <li data-category="all" class="active">全部文章</li>
